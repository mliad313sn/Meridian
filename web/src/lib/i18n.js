...
export const FR = {
  ...
  "Annual, once delivered. The benefits register holds the measured truth.": "Annuel, une fois livré. Le registre des bénéfices tient la vérité mesurée.",
  "Basis: ": "Base : ",
  "Business case": "Cas d'affaire",
  "Expected benefit ($M/yr)": "Bénéfice attendu (M$/an)",
  "Expected benefit / yr": "Bénéfice attendu / an",
  ...
  "Only the programme office writes it — the deliverer executes the justification, it does not author it.": "Seul le bureau de programme l'écrit — celui qui livre exécute la justification, il ne la rédige pas.",
  "Revise": "Réviser",
  "Revise the business case": "Réviser le cas d'affaire",
  "Revised after its last reconfirmation — what was reconfirmed is not what is written below.": "Révisé après sa dernière reconfirmation — ce qui a été reconfirmé n'est pas ce qui est écrit ci-dessous.",
  "Save the case": "Enregistrer le cas",
  "Still worth doing?": "Cela vaut-il encore la peine ?",
  "The justification in the payer's words — what the group gets, not how the team will build it.": "La justification dans les mots de qui paie — ce que le groupe obtient, pas comment l'équipe le construira.",
  "This records that the justification holds, at the current gate, under your name.": "Ceci consigne que la justification tient, au jalon courant, sous votre nom.",
  "What the numbers rest on": "Sur quoi les chiffres reposent",
  "What was promised when the money was asked for. The ledger holds what actually happened.": "Ce qui a été promis quand l'argent a été demandé. Le grand livre tient ce qui s'est réellement passé.",
  "Why this project": "Pourquoi ce projet",
  "Write it": "L'écrire",
  "Write the business case": "Écrire le cas d'affaire",
  "changed since it was last reconfirmed": "modifié depuis sa dernière reconfirmation",
  "gate ": "jalon ",
  "none written": "aucun écrit",
  "reconfirmed at gate ": "reconfirmé au jalon ",
  "written ": "écrit le ",
  "written, never reconfirmed at a gate": "écrit, jamais reconfirmé à un jalon",
  ...
  "Unrestricted, including accounts, grants and global settings":
    "Sans restriction, y compris les comptes, les habilitations et les réglages globaux",
  ...
  "Quiet hours need both ends, or neither":
    "Les heures de silence exigent les deux bornes, ou aucune",
  ...
  "With none, the cadence above governs everything. With any, only what a subscription covers goes out — the centre always receives everything.":
    "Sans aucun, la cadence ci-dessus gouverne tout. Avec, seul ce qu'un abonnement couvre part — le centre, lui, reçoit toujours tout.",
  "Whole portfolio": "Tout le portefeuille",
  "Everything": "Tout",
  "Subscriptions": "Abonnements",
  "Minimum severity": "Gravité minimale",
  /* O-2 (docs/32 → docs/36 C-04) — le panneau des notifications nomme le vrai transport. */
  "an outbound webhook is configured": "un webhook sortant est configuré",
  "no outbound webhook — messages queue and are shown here":
    "aucun webhook sortant — les messages attendent en file et s'affichent ici",
  ...
  "Nothing is sent until the outbound webhook is configured: MERIDIAN_NOTIFY_URL or MERIDIAN_TEAMS_WEBHOOK, plus its host in the trusted webhook hosts setting. Until then this is what people would have been told — deliberately visible rather than silent.":
    "Rien ne part tant que le webhook sortant n'est pas configuré : MERIDIAN_NOTIFY_URL ou MERIDIAN_TEAMS_WEBHOOK, plus son hôte dans les hôtes de webhook de confiance. D'ici là, voici ce que les gens auraient reçu — délibérément visible plutôt que silencieux.",
  ...
  "Backlog — in no sprint":
    "Carnet — dans aucun sprint",
  "Empty is the backlog. A closed sprint takes no new item.":
    "Vide : le carnet. Un sprint clos ne reçoit plus d'élément.",
  "Delivers stage":
    "Livre l'étape",
  "The stage this item delivers. A stage measured from its items reads its progress from their points.":
    "L'étape que cet élément livre. Une étape mesurée par ses éléments lit son avancement dans leurs points.",
  "Measure progress from the board":
    "Mesurer l'avancement depuis le tableau",
  "Now {pct}%: {done} of {total} points done. The typed {reported}% returns if you turn this off.":
    "Actuellement {pct} % : {done} points faits sur {total}. Les {reported} % saisis reviennent si vous désactivez.",
  "On: done points ÷ total points of the work items linked to this stage, instead of the typed %.":
    "Activé : points faits ÷ points totaux des éléments liés à cette étape, au lieu du % saisi.",
  "Choose one project":
    "Choisissez un projet",
  "Sprints belong to a project: pick one in the Board selector.":
    "Un sprint appartient à un projet : choisissez-en un dans le sélecteur Tableau.",
  "New sprint":
    "Nouveau sprint",
  "points per sprint, last {n} closed":
    "points par sprint, {n} derniers clos",
  "no sprint closed yet":
    "aucun sprint clos",
  "items with no points are in no chart":
    "sans points, un élément n'est dans aucun graphique",
  "{n} delivered":
    "{n} livrés",
  "No sprint yet":
    "Aucun sprint",
  "A project without sprints works exactly as before.":
    "Un projet sans sprint fonctionne exactement comme avant.",
  "Ideal":
    "Idéal",
  "Delivered":
    "Livrés",
  "Average of the last three":
    "Moyenne des trois derniers",
  "Its items go back to the backlog.":
    "Ses éléments retournent au carnet.",
  "Edit sprint":
    "Modifier le sprint",
  "A sprint cannot end before it starts":
    "Un sprint ne peut pas finir avant de commencer",
  "Sprint goal":
    "Objectif du sprint",
  "What the team commits to — read at the review by people who were not there.":
    "Ce à quoi l'équipe s'engage — lu à la revue par des gens qui n'y étaient pas.",
  "Save sprint":
    "Enregistrer le sprint",
  "Unfinished items go to":
    "Les éléments non terminés vont",
  "{n} items not Done ({points} points). Closing records the points delivered, which velocity reads.":
    "{n} éléments non terminés ({points} points). Clore consigne les points livrés, que lit la vélocité.",
  "Close sprint":
    "Clore le sprint",
  "Sprint planning":
    "Planification du sprint",
  "Days after today have no data yet.":
    "Les jours après aujourd'hui n'ont pas encore de données.",
  "{n} points were done on a day nobody recorded: they count on the last day, not before.":
    "{n} points ont été faits un jour que personne n'a consigné : ils comptent le dernier jour, pas avant.",
  "Empty means nobody has estimated it — it then counts in no sprint chart.":
    "Vide : personne ne l'a estimé — il ne compte alors dans aucun graphique de sprint.",
};
