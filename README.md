...
server/          src/env.js        .env, the data directory, the one version number
                 ...
                 migrations/       ordered SQL (001–063, 69 tables, applied at boot)
...
| [`docs/37-technical-reference.md`](docs/37-technical-reference.md) | **Technical reference** (EN) — project description, the module map, the 69-table database schema, every functionality, the API surface, the 21 screens, deployment, and the known limits, each with its `docs/36` line |
