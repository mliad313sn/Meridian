...
import { MASTER_ES } from "./i18n-master.js";
...
export const ES = {
  ...
  ...MASTER_ES, // docs/41 FX-15 — the programme master schedule, typed cross-project links
  ...
  /* FX-01…FX-04 (docs/41, 061) — el motor de planificación: vínculos tipados,
     calendarios laborales, restricciones, reales. */
  "Unknown or repeated predecessor":
    "Predecesor desconocido o repetido",
  "Predecessors":
    "Predecesores",
  "Code, then type and lag in days: A2 SS+3. FS is the default; negative is a lead.":
    "Código, luego tipo y desfase en días: A2 SS+3. FS por defecto; negativo = adelanto.",
  "Date constraint":
  ...
  "SNET/SNLT start no earlier/later than, FNET/FNLT finish, MSO/MFO must start/finish on. Never moves your dates: an unmet one shows as negative float.":
    "SNET/SNLT inicio no antes/después de, FNET/FNLT fin, MSO/MFO inicio/fin obligatorio. Nunca mueve sus fechas: si no se cumple, da holgura negativa.",
  "Constraint date":
    "Fecha de restricción",
  "Required unless ASAP.":
    "Obligatoria salvo ASAP.",
  "Deadline":
    "Fecha límite",
  "Missing it is flagged; it never moves the plan.":
    "Incumplirla se señala; nunca mueve el plan.",
  "Actual start":
    "Inicio real",
  "When the work really began; the stage is then scheduled from its actuals.":
    "Cuándo empezó de verdad; la etapa se calcula entonces con sus reales.",
  "Actual finish":
    "Fin real",
  "When the work really ended — after the actual start.":
    "Cuándo terminó de verdad — después del inicio real.",
  "Remaining (days)":
    "Restante (días)",
  "Counted from the status date. Empty: the planned duration.":
    "Contado desde la fecha de estado. Vacío: la duración prevista.",
  "Free float":
    "Holgura libre",
  "Negative float":
    "Holgura negativa",
  ...
  "Durations and lags count its working days. Inherited: the site's, else the group default, else calendar days.":
    "Duraciones y desfases cuentan sus días laborables. Heredado: el del sitio, si no el del grupo, si no días naturales.",
  "Schedule and earned value are measured at it. Empty: the portfolio's.":
    "El plan y el valor ganado se miden en ella. Vacío: la de la cartera.",
  "The site, country or roster it describes.":
    "El sitio, el país o la rotación que describe.",
  "Non-working days":
    "Días no laborables",
  "One per line: YYYY-MM-DD, then a label.":
    "Uno por línea: AAAA-MM-DD y una etiqueta.",
  "Group default":
    "Predeterminado del grupo",
  "For every project whose site names none. One default only.":
    "Para todo proyecto cuyo sitio no indica ninguno. Uno solo.",
  "The agreement or roster these days come from.":
    "El acuerdo o la rotación de donde vienen estos días.",
  "Working calendars":
    "Calendarios laborales",
  "Without one, a project counts calendar days.":
    "Sin calendario, un proyecto cuenta días naturales.",
  "Working days":
    "Días laborables",
  "Used by":
    "Usado por",
  "Refused while a project or a site uses it.":
    "Se rechaza mientras lo use un proyecto o un sitio.",
  "Sun":
    "Dom",
  "Mon":
    "Lun",
  ...
  "Sat":
    "Sáb",
  /* docs/41 wave B — recursos y costes (FX-08, FX-09, FX-10). */
  "d": "d",
  "away": "ausente",
  "Load against effective availability": "Carga frente a la disponibilidad real",
  "Propose leveling": "Proponer una nivelación",
  "Over-allocation": "Sobreasignación",
  "person(s) over their availability": "persona(s) por encima de su disponibilidad",
  "Leveling proposal": "Propuesta de nivelación",
  "Activity": "Actividad",
  "Nothing to propose": "Nada que proponer",
  "finish": "fin",
  "over-allocated week(s)": "semana(s) sobreasignada(s)",
  "Leveling applied": "Nivelación aplicada",
  "Apply selected moves": "Aplicar la selección",
  "Units": "Unidades",
  "Work": "Trabajo",
  ...
  "A person or a role, never both.": "Una persona o un rol, nunca ambos.",
  "Units (%)": "Unidades (%)",
  "50 = half-time, 200 = two people.": "50 = media jornada, 200 = dos personas.",
  "Work (person-days)": "Trabajo (días-persona)",
  "Empty = duration × units.": "Vacío = duración × unidades.",
  "Assignment updated": "Asignación actualizada",
  "Assignment added": "Asignación añadida",
  "Day rate": "Tarifa diaria",
  "Rates": "Tarifas",
  "Add rate": "Añadir una tarifa",
  "No rates yet": "Aún no hay tarifas",
  "Rate removed": "Tarifa retirada",
  "Whole units of the currency.": "En unidades enteras de la moneda.",
  "Rate updated": "Tarifa actualizada",
  "Rate set": "Tarifa fijada",
  "Estimate at completion, three ways": "Estimación a la conclusión, tres métodos",
  "Nothing measured": "Nada medido",
  "Method": "Método",
  "work ÷ available FTE, absences deducted": "trabajo ÷ ETC disponible, ausencias descontadas",
  "Nothing has moved yet.": "Nada se ha movido todavía.",
  "* typed work": "* trabajo introducido",
  "Shifts, conditions.": "Turnos, condiciones.",
  "person › role › directory": "persona › rol › directorio",
  "Per unit, in the reporting currency.": "Por unidad, en la moneda de reporte.",
  "Its source (contract).": "Su fuente (contrato).",
  "too early to measure": "demasiado pronto para medir",
  "no costed assignment": "ninguna asignación con coste",
...
export const ES_FRAG = [
  /* docs/41 FX-09 — por qué el nivelador movió una actividad (ver FR). */
  [/Within total float \((-?\d+) d\)/g, "Dentro de la holgura total ($1 d)"],
  [/Delayed: lower priority \(rank (\w+), float (-?\d+) d\)/g, "Retrasada: prioridad más baja (rango $1, holgura $2 d)"],
  [/Pushed by its predecessor /g, "Empujada por su predecesora "],
