...
| **PM-08** | **LEVÉE le 31/08/2026** | Migration 032 : la marche vers Closed exige l'exploitant nommé qui reprend, le propriétaire de bénéfice qui accepte le relais, et le mot de la fin. Refus 400 sinon, dialogue de passation à l'écran. |
| **PM-04** | **LEVÉE le 31/08/2026** | Migration 032 : critères d'acceptation posés d'avance ; un jalon AVEC critères ne se coche qu'en nommant qui a constaté — le nom reste ; sans critères, comme avant. |
| **PM-06** | **LEVÉE le 31/08/2026** | Migration `030` : cible résiduelle P×I sur le RAID (nullable — Accept n'a pas de cible, un chiffre inventé serait une fausse assurance) ; un tirage de provision NOMME le risque qu'il finance dès qu'un risque ouvert existe, et le grand livre le garde ligne à ligne. 6 tests. |
| **PM-03** | **LEVÉE le 31/08/2026** | Migration `028`, un cas UNIQUE par projet, écrit et reconfirmé par le groupe seul, 7 tests. La question de PRINCE2 — « cela vaut-il ENCORE la peine ? » — devient un acte daté à un jalon ; un cas révisé après reconfirmation LE DIT (ordre des événements, pas horloge : deux dates du même jour ne savent pas dire qui fut premier). Exercé au navigateur : écrit → reconfirmé jalon 1 → révisé → l'écran avertit. |
