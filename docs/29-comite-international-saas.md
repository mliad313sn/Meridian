...
| **I18N-02** | **L'espagnol.** Dictionnaire complet + messages serveur, en brouillon jusqu'à relecture native. | Le premier bassin minier hors anglophonie ne peut pas déployer | 2 j |
